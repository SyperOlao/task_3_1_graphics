...
namespace task_3_1
{
    class RoundedConner
    {
        public void DrawRoundedCorner(Graphics graphics, PointF angularPoint,
                                PointF p1, PointF p2, float radius, Color color)
        {
            //Vector 1
        ...
        public PointF GetProportionPoint(PointF point, double segment,
